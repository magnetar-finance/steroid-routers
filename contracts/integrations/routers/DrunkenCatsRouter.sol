...
import {IDrunkenCatsRouter} from '../interfaces/IDrunkenCatsRouter.sol';
import {IUniswapV2Factory} from '../interfaces/IUniswapV2Factory.sol';
import {IUniswapV2Pair} from '../interfaces/IUniswapV2Pair.sol';
import '@openzeppelin/contracts/token/ERC20/IERC20.sol';

contract DrunkenCatsRouter is BaseRouter {
    IDrunkenCatsRouter public immutable baseSwapRouter;
    IUniswapV2Factory public immutable baseFactory;

    constructor(IDrunkenCatsRouter _baseSwapRouter) BaseRouter() {
    ...
    function _swap(
        ...
        // Swap
        baseSwapRouter.swapExactTokensForTokens(amountIn, amountOut, path, to, deadline);
    }
}
